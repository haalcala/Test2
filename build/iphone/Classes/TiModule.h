...
/**
 The base class for all GitHubTest modules
 */
...
/**
 GitHubTest Platform calls this method on startup.
 */
-(void)startup;

/**
 GitHubTest Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 GitHubTest Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 GitHubTest Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 GitHubTest Platform calls this method on resume.
 @param sender The sender of the event.
 */
