...
// in simulator we redefine to format for GitHubTest Developer console
...
{\
	NSString * exceptionName = [@"org.githubtest." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.githubtest";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGitHubTestNativeItemNone = -1, 
	UIGitHubTestNativeItemSpinner = -2,
	UIGitHubTestNativeItemProgressBar = -3,
	
	UIGitHubTestNativeItemSlider = -4,
	UIGitHubTestNativeItemSwitch = -5,
	UIGitHubTestNativeItemMultiButton = -6,
	UIGitHubTestNativeItemSegmented = -7,
	
	UIGitHubTestNativeItemTextView = -8,
	UIGitHubTestNativeItemTextField = -9,
	UIGitHubTestNativeItemSearchBar = -10,
	
	UIGitHubTestNativeItemPicker = -11,
	UIGitHubTestNativeItemDatePicker = -12,
	
	UIGitHubTestNativeItemInfoLight = -13,
	UIGitHubTestNativeItemInfoDark = -14,
	
	UIGitHubTestNativeItemDisclosure = -15,
	
	UIGitHubTestNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GitHubTest instances of
