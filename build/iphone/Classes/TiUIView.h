...
/**
 Base class for all GitHubTest views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GitHubTest view hierarchy (such as wrapped iOS UIViews) was touched.
