 ...
 * Copyright (c) 2009-2011 by GitHubTest, Inc. All Rights Reserved.
...
//@interface GitHubTestObject : NSObject
//@end

@interface GitHubTestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GitHubTestObject class]])
		{
			for (NSString *key in [[(GitHubTestObject*)o modules] allKeys])
			{
