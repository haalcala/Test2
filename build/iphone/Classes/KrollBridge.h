...
@interface GitHubTestObject : KrollCoverageObject {
#else
@interface GitHubTestObject : KrollObject {
#endif
@private
...
extern NSString * GitHubTest$ModuleRequireFormat;
